    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        switch (keyCode) {
            case KeyEvent.KEYCODE_1:
                SharedPreferences sharedPreferences = getSharedPreferences("org.videolan.vlc.debug_preferences", Activity.MODE_PRIVATE);
                String url = sharedPreferences.getString("current_media","http://10.10.10.188/live/livestream.m3u8");

                VideoPlayerActivity.start(this, Uri.parse(url));
                break;

            case KeyEvent.KEYCODE_2:
                VideoPlayerActivity.start(this, Uri.parse("file:///storage/usb_storage/vol2/4k_fromOCN/bxqy.mp4"));
                break;

            case KeyEvent.KEYCODE_3:
                VideoPlayerActivity.start(this, Uri.parse("file:///storage/usb_storage/vol2/4k_fromOCN/sjnrzhm.mp4"));
                break;

            case KeyEvent.KEYCODE_4:
                VideoPlayerActivity.start(this, Uri.parse("http://10.10.10.188/live/livestream.m3u8"));
                break;

            case KeyEvent.KEYCODE_5:
                VideoPlayerActivity.start(this, Uri.parse("http://10.10.10.188/vod/ssjj/ssjj.m3u8"));
                break;

            case KeyEvent.KEYCODE_6:
                VideoPlayerActivity.start(this, Uri.parse("http://10.10.10.188/vod/ysys.mp4"));
                break;
        }
